...
struct SignupView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Text("Access  to  Questions, Homeworkhelp and online Tutors")
                .font(.headline)
    ...
    var form: some View {
        Group {
            ...
            Text("By clicking on Sign up, you agree to our **[Terms of service](https://familiaressays.com)** and **Privacy policy**.")
                .font(.footnote)
                .foregroundColor(.primary.opacity(0.7))
